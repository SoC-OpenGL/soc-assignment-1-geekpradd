...
void genVertices(){
  ...
  while(i<6*no_of_segments){
    vertices[i] = radius*cos(angle)*cos(angle)*cos(angle); i++;
    vertices[i] = radius*sin(angle)*sin(angle)*sin(angle)*aspect_ratio;i++;
    vertices[i] = radius*cos(angle+increm)*cos(angle+increm)*cos(angle+increm); i++;
    vertices[i] = radius*sin(angle+increm)*sin(angle+increm)*sin(angle+increm)*aspect_ratio; i++;
    vertices[i] = 0.0f; i++;
    vertices[i] = 0.0f; i++;
